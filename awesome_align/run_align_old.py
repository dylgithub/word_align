...
def main():
    ...
    # Required parameters
    parser.add_argument(
        "--data_file", default="../data/word_align_use.txt", type=str, required=True, help="The input data file (a text file)."
    )
    parser.add_argument(
        "--output_file",
        type=str,
    ...
    parser.add_argument(
        "--output_prob_file", default="outputs", type=str, help='The output probability file.'
    )
    parser.add_argument(
        "--output_word_file", default="outputs", type=str, help='The output word file.'
    )
    parser.add_argument(
        "--model_name_or_path",
        default="../rbt3",
